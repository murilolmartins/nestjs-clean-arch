...
export type SearchResultToJson<E extends Entity, Filter> = SearchResultProps<
    E,
    Filter
> & { lastPage: number }
...
export class SearchParams<Filter = string> {
    ...
    private set sortDir(value: string | null) {
        ...
        this._sortDir = isSortDirection(dir) ? dir : SortDirectionEnum.DESC
    }
...
export class SearchResult<E extends Entity, Filter = string> {
    ...
    toJSON(forceEntity = false): SearchResultToJson<E, Filter> {
        return {
            items: forceEntity
